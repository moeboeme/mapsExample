...
<body style="padding-left:20px;padding-right: 20px; ">	
		 ...
		 <li>Crear Mapa:
		 	<ol>
			 	...
			 	<pre>
			 		...
			 		* 'mapa' es el id del div que va a ser contenedor contenedor.
			 	</pre>
			 	<li>Estamos listos para crear marcadores, poligonos o cualquier otra figura en él</li>
			 	<p>A los elementos creados, pueden agregarse eventos para ejecutar funciones, por ejemplo click,hover, etc</p>
			 	<p>Es muy importante agregar el elemento al mapa una vez creado ' .addTo(mapa); ' </p>
			 	<pre>
			 		<xmp>
			 			<script type="text/javascript">
	...
	<ul>
		...
		<li><a href="https://www.openstreetmap.org/#map=4/-40.44/-63.59">OpenStreetMap:</a> es un proveedor de mapas, ádemas de permitir crear y editar mapas ya existentes, posee APIs que permiten a leaflet cargar de a Porciones el mapa en su contenedor.</li>
	</ul> 	
	<h3>Ver Támbien:</h3>
	<ul>
		...
		<li><a href="https://github.com/Leaflet/Leaflet.markercluster">Marker Cluster:</a>Permite agrupar marcadores en uno, a medida que nos acercamos los marcadores se desagrupan</li>
